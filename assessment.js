'use strict';
 ...
 assessmentButton.onclick = () => {
     ...
     resultDivided.appendChild(header); //divのなかに入れる

     const paragraph = document.createElement('p'); // document.write('<p>タグの中身</p>')
...
userNameInput.onkeydown = (event) => {
 ...
 const answers = [
    ...
    '{userName}のいいところは見た目です。内側から溢れ出る{userName}の良さに皆が心を惹かれます。',
    '{userName}のいいところは決断力です。{userName}がする決断にいつも助けられる人がいます。',
    '{userName}のいいところは思いやりです。{userName}に気をかけてもらった多くの人が感謝しています。',
    '{userName}のいいところは感受性です。{userName}が感じた事にみんなが共感し、わかりあうことができます。',
